            ...
            <div className="profile_icon">
                ...
                <div className="notificationContainer notificationInactive" ref={notificationdiv} id="notificationContainer">
                    <div className="notification">
                        ...
                        <p className="abortNotification" onClick={removeNotification}>x</p>
                    </div>
                    <div className="notification">
                        <p>Failure Detected</p>
                    </div>
                ...
                {!isloggedin &&
                    <div className="loginContainer loginContainernew" ref={logindiv}>
                        <form>
                            <input type="text" className="username" value={user} onChange={(e)=>setUser(e.target.value)}></input>
                            <input type="password" className="password" value={password} onChange={(e)=>setPassword(e.target.value)}></input>
